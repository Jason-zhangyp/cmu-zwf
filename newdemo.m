...
% Description : main function of new formulation of role assignment
% Author      : Weifan Zhang 
% Date        : Sept 14, 2018
% Other Files :

function [] = newdemo(N, t) %N>=5
    ...
    for i= 1:(t/dt)
        pause(dt/10000)
        [poses_1, assignment1] = new_role_assignment(poses_1, formation, dt, i, assignment1,1);
        ...
        grid(ax1,'on')        
        title(ax1,'original role assignment formulation')
        ...
        [poses_2, assignment2] = new_role_assignment(poses_2, formation, dt, i, assignment2,2);
        ...
        grid(ax2,'on')
        title(ax2,'new role assignment formulation')
