...
% Description : role assignment - Line,circle,square
% Author      : Weifan Zhang 
...
function [] = demo2(N, t)
    ...
    %show = zeros(1,N);
    assignment = assign_init(formation, poses_in);
    for i= 1:(t/dt)
        pause(dt)
        [poses_out, assignment, show] = role_formation_control3(poses_in, formation, dt, assignment);
